...
st.image("home_image.jpeg", caption="Study in Europe", use_container_width=True)  # Placeholder for image
...
st.image("europe_image.jpeg", caption="Beautiful European Campuses", use_container_width=True)  # Placeholder for image
